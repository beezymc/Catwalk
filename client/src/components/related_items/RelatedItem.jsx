...
const RelatedItem = (props) => {
  ...
  if (props.relatedItem && props.relatedStyle && props.relatedItemReview && props.currentProduct) {
    ...
    return (
      <div>
        {isOpen && <CompareItem relatedItem={relatedItem} currentItem={props.currentItem} handleClose={togglePopup} />}
        <div className={styles.cornerSymbol} onClick={togglePopup}>
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 36.09 40.09">
        ...
        <div className={styles.innerCard} onClick={() => { props.handleProductInit(relatedItem.id); }}>
